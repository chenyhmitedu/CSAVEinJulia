...
y_j_data = df_final_j.mg + df_final_j.sol
x_g_data = string.(df_final_g.setting)
y_g_data = df_final_g.mg + df_final_g.sol
...
p_usa_julia = bchart(x_j_data, y_j_data, "Model generation + solve time:\n CSAVEinJulia")
p_usa_gams = bchart(x_g_data, y_g_data, "Model generation + solve time:\n CSAVEinGAMS")
...
outpath = joinpath(@__DIR__, "./figures/", "barchart_mg+sol_julia_vs_GAMS.png")
